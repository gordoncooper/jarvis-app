...
- **2026-09-23** — Breath dialogue uses the CMD channel's type: operator in
  IBM Plex Sans and ink, JARVIS in IBM Plex Mono and the cockpit bronze
  (`--ck-accent-warm`). The CMD assistant bubble and the confirm card use
  that same bronze.
